...
class WorkerTransport {
  constructor(messageHandler, loadingTask, networkStream, params) {
    ...
    if (!params.useWorkerFetch) {
      ...
      console.log("this.StandardFontDataFactory", this.StandardFontDataFactory);
    }
...
class PDFFetchStreamReader {
  constructor(stream) {
    ...
    let url = source.url;
    const splitedUrl = source.url.split("pdfUrl=");

    if (splitedUrl.length > 1) {
      url = splitedUrl[0] + "pdfUrl=" + encodeURIComponent(splitedUrl[1]);
    }
